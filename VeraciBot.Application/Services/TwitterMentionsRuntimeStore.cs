...
namespace VeraciBot.Application.Services
{
    ...
    public sealed class TwitterMentionsRuntimeStore
    {
        ...
        public TwitterMentionsRuntimeStore(
            int maxQueueSize = ApplicationDefaults.TwitterWorkerMaxQueueSize,
            int maxLogEntries = ApplicationDefaults.TwitterWorkerMaxLogEntries)
        {
        ...
        public void MarkProcessingCompleted(TwitterMentionQueueItem item, string result)
        {
            ...
            AddAgentLog("info", $"Mencao {item.Id} concluida: {GetResultLabel(normalizedResult)}.");
        }
        ...
        public void MarkProcessingSkipped(TwitterMentionQueueItem item, string reason)
        {
            ...
            AddAgentLog("warning", $"Mencao {item.Id} ignorada: {GetResultLabel(normalizedReason)}.");
        }
        ...
        public void MarkProcessingFailed(TwitterMentionQueueItem item, Exception exception)
        {
            ...
            AddAgentLog("error", $"Erro ao processar mencao {item.Id}: {exception.Message}");
        }
        ...
        public static string GetResultLabel(string result)
        {
            return NormalizeResult(result) switch
            {
                ...
                "NOT_AUTHORIZED" => "usuario nao autorizado",
                ...
                "OPENAI_NOT_CONFIGURED" => "OpenAI nao configurada",
                "ALREADY_PROCESSED" => "ja processada",
