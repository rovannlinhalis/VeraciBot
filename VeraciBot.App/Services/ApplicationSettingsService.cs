...
namespace VeraciBot.App.Services
{
    ...
    public class ApplicationSettingsService
    {
        ...
        public static List<ApplicationSettings> _defaultSettings = new List<ApplicationSettings>
        {
            ...
            new ApplicationSettings() { Parameter = ApplicationParameter.HELP_IMAGE, Name = "Imagem de Ajuda", Type = EFieldType.ImageUrl, Value = "logo.jpg", Description = "Imagem usada na resposta de ajuda.", Group = "Agent", Order = 130, Subgroup = "Ajuda", Size = EFieldSize.Small },
            new ApplicationSettings() { Parameter = ApplicationParameter.NO_AUTHORIZED_IMAGE, Name = "Imagem de Não Autorizado", Type = EFieldType.ImageUrl, Value = "no.jpg", Description = "Imagem usada quando o usuário não está autorizado.", Group = "Agent", Order = 140, Subgroup = "Autorização", Size = EFieldSize.Small },
            new ApplicationSettings() { Parameter = ApplicationParameter.SCORE_IMAGE, Name = "Imagem de Pontuação", Type = EFieldType.ImageUrl, Value = "logo.jpg", Description = "Imagem usada na resposta de pontuação individual.", Group = "Agent", Order = 150, Subgroup = "Pontuação - Consulta", Size = EFieldSize.Small },
            new ApplicationSettings() { Parameter = ApplicationParameter.SCORE_BOARD_IMAGE, Name = "Imagem do Placar", Type = EFieldType.ImageUrl, Value = "logo.jpg", Description = "Imagem usada na resposta do placar.", Group = "Agent", Order = 160, Subgroup = "Pontuação - Placar", Size = EFieldSize.Small },
            new ApplicationSettings() { Parameter = ApplicationParameter.INVITE_IMAGE, Name = "Imagem de Convite", Type = EFieldType.ImageUrl, Value = "invite.jpg", Description = "Imagem usada ao enviar convite.", Group = "Agent", Order = 180, Subgroup = "Convite - Envio", Size = EFieldSize.Small },
            new ApplicationSettings() { Parameter = ApplicationParameter.INVITE_NO_USER_IMAGE, Name = "Imagem de Convite sem Usuário", Type = EFieldType.ImageUrl, Value = "no.jpg", Description = "Imagem usada quando o usuário do convite não é informado ou não é encontrado.", Group = "Agent", Order = 190, Subgroup = "Convite - Usuário não encontrado", Size = EFieldSize.Small },
            new ApplicationSettings() { Parameter = ApplicationParameter.INVITE_ERROR_IMAGE, Name = "Imagem de Erro no Convite", Type = EFieldType.ImageUrl, Value = "no.jpg", Description = "Imagem usada quando houver erro no convite.", Group = "Agent", Order = 200, Subgroup = "Convite - Erro", Size = EFieldSize.Small },
            new ApplicationSettings() { Parameter = ApplicationParameter.ACCEPT_IMAGE, Name = "Imagem de Aceite", Type = EFieldType.ImageUrl, Value = "logo.jpg", Description = "Imagem usada quando o convite é aceito.", Group = "Agent", Order = 210, Subgroup = "Convite - Aceite", Size = EFieldSize.Small },
            new ApplicationSettings() { Parameter = ApplicationParameter.FAILED_UNDERSTAND_ACCEPT_IMAGE, Name = "Imagem de Falha no Aceite", Type = EFieldType.ImageUrl, Value = "duvida.jpg", Description = "Imagem reservada para falhas de entendimento durante o aceite do convite.", Group = "Agent", Order = 212, Subgroup = "Convite - Falha no Aceite", Size = EFieldSize.Small },
            new ApplicationSettings() { Parameter = ApplicationParameter.REFUSE_IMAGE, Name = "Imagem de Recusa", Type = EFieldType.ImageUrl, Value = "no.jpg", Description = "Imagem usada quando o convite é recusado.", Group = "Agent", Order = 220, Subgroup = "Convite - Recusa", Size = EFieldSize.Small },
            new ApplicationSettings() { Parameter = ApplicationParameter.FAILED_UNDERSTAND_IMAGE, Name = "Imagem de Comando Desconhecido", Type = EFieldType.ImageUrl, Value = "duvida.jpg", Description = "Imagem usada quando não for possível entender a mensagem.", Group = "Agent", Order = 240, Subgroup = "Comando Desconhecido", Size = EFieldSize.Small },
            ...
            new ApplicationSettings() { Parameter = ApplicationParameter.LANDING_HERO_IMAGE, Name = "Imagem Hero", Type = EFieldType.ImageUrl, Value = "logo.jpg", Description = "Imagem principal de destaque da página inicial.", Group = "Landing", Order = 310, Subgroup = "Visual", Size = EFieldSize.Medium },
            new ApplicationSettings() { Parameter = ApplicationParameter.LANDING_FEATURE_IMAGE, Name = "Imagem de Funcionalidade", Type = EFieldType.ImageUrl, Value = "resp0.jpg", Description = "Imagem da seção de funcionalidades da página inicial.", Group = "Landing", Order = 311, Subgroup = "Visual", Size = EFieldSize.Medium },
            ...
            new ApplicationSettings() { Parameter = ApplicationParameter.THREAD_RESULT_A_IMAGE, Name = "Imagem Resultado A", Type = EFieldType.ImageUrl, Value = "resp1.jpg", Description = "Imagem quando o usuário A vence a discussão.", Group = "Agent", Order = 230, Subgroup = "Debate - Resultado", Size = EFieldSize.Small },
            new ApplicationSettings() { Parameter = ApplicationParameter.THREAD_RESULT_B_IMAGE, Name = "Imagem Resultado B", Type = EFieldType.ImageUrl, Value = "resp2.jpg", Description = "Imagem quando o usuário B vence a discussão.", Group = "Agent", Order = 231, Subgroup = "Debate - Resultado", Size = EFieldSize.Small },
            new ApplicationSettings() { Parameter = ApplicationParameter.THREAD_RESULT_DRAW_IMAGE, Name = "Imagem Empate/Verificação", Type = EFieldType.ImageUrl, Value = "resp0.jpg", Description = "Imagem usada quando há empate ou em respostas de verificação factual.", Group = "Agent", Order = 232, Subgroup = "Debate - Resultado", Size = EFieldSize.Small },
